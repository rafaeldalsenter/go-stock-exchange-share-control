...
func TestNewPurchaseWithDomainError(t *testing.T) {
	...
	err := useCase.NewPurchase("", date, quantity, value, tax)
...
func TestNewPurchaseWithRepositoryError(t *testing.T) {
	...
	err := useCase.NewPurchase(code, date, quantity, value, tax)
...
func TestNewSaleWithDomainError(t *testing.T) {
	...
	err := useCase.NewSale("", date, quantity, value, tax)
...
func TestNewSaleWithRepositoryError(t *testing.T) {
	...
	err := useCase.NewSale(code, date, quantity, value, tax)
